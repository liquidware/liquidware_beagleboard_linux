...
MUX_CFG_34XX("AF3_34XX_GPIO138_OUT", 0x168,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("AE3_34XX_GPIO139_OUT", 0x16a,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
...
MUX_CFG_34XX("AF5_34XX_GPIO142", 0x170,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT)
MUX_CFG_34XX("AE5_34XX_GPIO143_OUT", 0x172,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("AB26_34XX_GPIO144_OUT", 0x174,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("AA25_34XX_GPIO146_UP", 0x178,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT)
#if 0
/* MCSPI3 */
MUX_CFG_34XX("XXX_3430_MCSPI3_CLK_OUT", 0x158,
		OMAP34XX_MUX_MODE1 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("XXX_3430_MCSPI3_SIMO_OUT", 0x15a,
		OMAP34XX_MUX_MODE1 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("XXX_3430_MCSPI3_SOMI", 0x15c,
		OMAP34XX_MUX_MODE1 | OMAP34XX_PIN_INPUT_PULLUP)
MUX_CFG_34XX("XXX_3430_MCSPI3_CS0_OUT", 0x162,
		OMAP34XX_MUX_MODE1 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("XXX_3430_MCSPI3_CS1_OUT", 0x160,
		OMAP34XX_MUX_MODE1 | OMAP34XX_PIN_OUTPUT)
