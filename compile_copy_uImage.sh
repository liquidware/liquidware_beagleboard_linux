...
installModules="sudo make -j8 INSTALL_MOD_PATH=${MOD_PATH} ARCH=arm modules modules_install CROSS_COMPILE=/home/eye/CodeSourcery/Sourcery_G++_Lite/bin/arm-none-linux-gnueabi-"
